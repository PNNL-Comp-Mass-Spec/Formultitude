    ...
    public class CChainBlocks {
        ...
        public double [] GetNoTrendErrorMasses( double [] Masses, double [] IdealMasses, Support.InputData Data) {
            ...
            for ( int PeakIndex = 0; PeakIndex < Masses.Length; ) {
                ...
                for ( ; PeakIndex < Masses.Length; PeakIndex++ ) {//to fill Lists specially not "NextPeakIndex = PeakIndex + 1"
        ...
        */
        public void AssignIdealMassesTheBiggestCluster( Support.InputData Data ) {//new
